...
.dropdown-content {
  background-color: white;
  border-radius: 4px;
  box-shadow: 2px 2px 25px 0px rgba(10, 10, 10, 0.3), 0px 0px 0px 1px rgba(10, 10, 10, 0.1);
...
.ui-navbar-button.is-active {
  box-shadow: 0px 0px 3px 0px #080808, 0px 0px 0px 1px #888888; }
...
.table-fixed {
  table-layout: fixed;
  /* https://stackoverflow.com/questions/5932018/fluid-table-with-td-nowrap-text-overflow */ }
